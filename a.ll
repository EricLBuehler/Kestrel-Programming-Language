...
; Function Attrs: noinline nounwind optnone
define i32 @g() local_unnamed_addr #0 !dbg !10 {
entry:
  ret i32 0, !dbg !14
}
...
!10 = distinct !DISubprogram(name: "g", linkageName: "g", scope: null, file: !2, line: 7, type: !11, scopeLine: 7, flags: DIFlagPublic, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition | DISPFlagOptimized, unit: !1, retainedNodes: !3)
!11 = !DISubroutineType(flags: DIFlagPublic, types: !12)
!12 = !{!13}
!13 = !DIBasicType(name: "i32", size: 16, flags: DIFlagPublic)
!14 = !DILocation(line: 7, scope: !15)
!15 = distinct !DILexicalBlock(scope: !10, file: !2, line: 7)
