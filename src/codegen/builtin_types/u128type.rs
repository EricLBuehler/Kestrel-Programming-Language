...
fn u128_add<'a>(codegen: &codegen::CodeGen<'a>, args: Vec<Data<'a>>, pos: &parser::Position) -> Data<'a> {
    ...
    return Data {
        ...
        tp: new_datatype(BasicDataType::U128, BasicDataType::U128.to_string(), None, Vec::new(), Vec::new(), None, false),
        owned: true,
    };
}
...
pub fn init_u128(codegen: &mut codegen::CodeGen) {
    ...
    traits.insert(TraitType::Add.to_string(), builtin_types::create_trait(u128_add, 2, TraitType::Add, new_datatype(BasicDataType::U128, BasicDataType::U128.to_string(), None, Vec::new(), Vec::new(), None, false)));
    traits.insert(TraitType::Mul.to_string(), builtin_types::create_trait(u128_mul, 2, TraitType::Mul, new_datatype(BasicDataType::U128, BasicDataType::U128.to_string(), None, Vec::new(), Vec::new(), None, false)));
    traits.insert(TraitType::Sub.to_string(), builtin_types::create_trait(u128_sub, 2, TraitType::Sub, new_datatype(BasicDataType::U128, BasicDataType::U128.to_string(), None, Vec::new(), Vec::new(), None, false)));
    traits.insert(TraitType::Div.to_string(), builtin_types::create_trait(u128_div, 2, TraitType::Div, new_datatype(BasicDataType::U128, BasicDataType::U128.to_string(), None, Vec::new(), Vec::new(), None, false)));
    traits.insert(TraitType::Pos.to_string(), builtin_types::create_trait(u128_pos, 1, TraitType::Pos, new_datatype(BasicDataType::U128, BasicDataType::U128.to_string(), None, Vec::new(), Vec::new(), None, false)));
