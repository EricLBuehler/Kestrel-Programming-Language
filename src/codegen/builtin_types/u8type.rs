...
fn u8_add<'a>(codegen: &codegen::CodeGen<'a>, args: Vec<Data<'a>>, pos: &parser::Position) -> Data<'a> {
    ...
    return Data {
        ...
        tp: new_datatype(BasicDataType::U8, BasicDataType::U8.to_string(), None, Vec::new(), Vec::new(), None, false, None),
        owned: true,
    };
}
...
pub fn init_u8(codegen: &mut codegen::CodeGen) {
    ...
    traits.insert(TraitType::Add.to_string(), builtin_types::create_trait(u8_add, 2, TraitType::Add, new_datatype(BasicDataType::U8, BasicDataType::U8.to_string(), None, Vec::new(), Vec::new(), None, false, None)));
    traits.insert(TraitType::Mul.to_string(), builtin_types::create_trait(u8_mul, 2, TraitType::Mul, new_datatype(BasicDataType::U8, BasicDataType::U8.to_string(), None, Vec::new(), Vec::new(), None, false, None)));
    traits.insert(TraitType::Sub.to_string(), builtin_types::create_trait(u8_sub, 2, TraitType::Sub, new_datatype(BasicDataType::U8, BasicDataType::U8.to_string(), None, Vec::new(), Vec::new(), None, false, None)));
    traits.insert(TraitType::Div.to_string(), builtin_types::create_trait(u8_div, 2, TraitType::Div, new_datatype(BasicDataType::U8, BasicDataType::U8.to_string(), None, Vec::new(), Vec::new(), None, false, None)));
    traits.insert(TraitType::Pos.to_string(), builtin_types::create_trait(u8_pos, 1, TraitType::Pos, new_datatype(BasicDataType::U8, BasicDataType::U8.to_string(), None, Vec::new(), Vec::new(), None, false, None)));
