...
fn f64_add<'a>(codegen: &codegen::CodeGen<'a>, args: Vec<Data<'a>>, pos: &parser::Position) -> Data<'a> {
    ...
    return Data {
        ...
        tp: new_datatype(BasicDataType::F64, BasicDataType::F64.to_string(), None, Vec::new(), Vec::new(), None, false, None),
        owned: true,
    };
}
...
fn f64_neg<'a>(codegen: &codegen::CodeGen<'a>, args: Vec<Data<'a>>, _pos: &parser::Position) -> Data<'a> {    
    ...
    return Data {
        data: Some(inkwell::values::BasicValueEnum::FloatValue(res)),
        tp: new_datatype(BasicDataType::F64, BasicDataType::F32.to_string(), None, Vec::new(), Vec::new(), None, false, None),
        owned: true,
    };
}
...
pub fn init_f64(codegen: &mut codegen::CodeGen) {
    ...
    traits.insert(TraitType::Add.to_string(), builtin_types::create_trait(f64_add, 2, TraitType::Add, new_datatype(BasicDataType::F64, BasicDataType::F64.to_string(), None, Vec::new(), Vec::new(), None, false, None)));
    traits.insert(TraitType::Mul.to_string(), builtin_types::create_trait(f64_mul, 2, TraitType::Mul, new_datatype(BasicDataType::F64, BasicDataType::F64.to_string(), None, Vec::new(), Vec::new(), None, false, None)));
    traits.insert(TraitType::Sub.to_string(), builtin_types::create_trait(f64_sub, 2, TraitType::Sub, new_datatype(BasicDataType::F64, BasicDataType::F64.to_string(), None, Vec::new(), Vec::new(), None, false, None)));
    traits.insert(TraitType::Div.to_string(), builtin_types::create_trait(f64_div, 2, TraitType::Div, new_datatype(BasicDataType::F64, BasicDataType::F64.to_string(), None, Vec::new(), Vec::new(), None, false, None)));
    traits.insert(TraitType::Pos.to_string(), builtin_types::create_trait(f64_pos, 1, TraitType::Pos, new_datatype(BasicDataType::F64, BasicDataType::F64.to_string(), None, Vec::new(), Vec::new(), None, false, None)));
    traits.insert(TraitType::Neg.to_string(), builtin_types::create_trait(f64_neg, 1, TraitType::Neg, new_datatype(BasicDataType::F64, BasicDataType::F64.to_string(), None, Vec::new(), Vec::new(), None, false, None)));
