...
fn f64_neg<'a>(codegen: &codegen::CodeGen<'a>, args: Vec<Data<'a>>, _pos: &parser::Position) -> Data<'a> {    
    ...
    return Data {
        data: Some(inkwell::values::BasicValueEnum::FloatValue(res)),
        tp: new_datatype(BasicDataType::F64, BasicDataType::F32.to_string(), None, Vec::new(), Vec::new(), None, false),
    };
}
...
pub fn init_f64(codegen: &mut codegen::CodeGen) {
    ...
    traits.insert(TraitType::Pos.to_string(), builtin_types::create_trait(f64_pos, 1, TraitType::Pos, new_datatype(BasicDataType::F64, BasicDataType::F64.to_string(), None, Vec::new(), Vec::new(), None, false)));
    traits.insert(TraitType::Neg.to_string(), builtin_types::create_trait(f64_neg, 1, TraitType::Neg, new_datatype(BasicDataType::F64, BasicDataType::F64.to_string(), None, Vec::new(), Vec::new(), None, false)));
