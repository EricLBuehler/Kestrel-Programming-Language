...
pub fn init_i128(codegen: &mut codegen::CodeGen) {
    ...
    traits.insert(TraitType::Pos.to_string(), builtin_types::create_trait(i128_pos, 1, TraitType::Pos, new_datatype(BasicDataType::I128, BasicDataType::I128.to_string(), None, Vec::new(), Vec::new(), None, false)));
    traits.insert(TraitType::Neg.to_string(), builtin_types::create_trait(i128_neg, 1, TraitType::Neg, new_datatype(BasicDataType::I128, BasicDataType::I128.to_string(), None, Vec::new(), Vec::new(), None, false)));
