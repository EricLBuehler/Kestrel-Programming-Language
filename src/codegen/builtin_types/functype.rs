...
pub fn init_func(codegen: &mut codegen::CodeGen) {
    ...
    traits.insert(TraitType::Call.to_string(), builtin_types::create_trait_func(fn_call, 0, TraitType::Call, crate::codegen::CodeGen::datatypes_get(codegen, &BasicDataType::Unknown.to_string()).unwrap().clone()));
    ...
    codegen.cur_module.datatypes.insert(BasicDataType::Func.to_string(), tp.clone());
